...
//class 명을 Controller로 작성하면 기존에 Spring에 존재하는 Controller와 충돌이나서 Spring안에 있는 Controller 기능을 사용하지 못함
@Controller
public class GoodsController {
	...
	// GoodsService에 숫자값이 아니면 들어가지 못하게 방지를 하거나, 비밀번호 암호화설정과 같은 상세기능을 넣고
	...
	public String insertGoods(Goods goods, Model model) {
		 ...
		 * 
		 * Model model = 돌아가기를 하거나, 새로고침과 같은 기능을 사용할 경우, html 파일에 데이터를 다시 절달하는 역할
		 * 또 다른의미로 임시저장
		 * */
