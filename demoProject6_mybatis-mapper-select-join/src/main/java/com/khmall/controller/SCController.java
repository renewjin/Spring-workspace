...
public class SCController {
	...
	public String getAllSC(Model model) {
		...
		/*
		 * 모든 db값 가져오는지 확인하기[com.khmall.dto.SC@5362d0af, com.khmall.dto.SC@34a2a0f4, com.khmall.dto.SC@2656838, com.khmall.dto.SC@4b80fdcf]
		 * DTO에서 @ToString을 이용하지 않으면 DB에서 가져오는 주소값만 보여주기 때문에
